...
<div id="istruzioni"> 
   <div class="container">
      <div class="col-md-4 i1"><p><span>1</span><?php echo utf8_decode('Collez le texte à découper en multiples sous-titres') ?></p></div>
      <div class="col-md-4 i2"><p><span>2</span><?php echo utf8_decode('Sélectionnez la version de Final Cut') ?></p></div>
      <div class="col-md-4 i3"><p><span>3</span><?php echo utf8_decode('Téléchargez le fichier xml contenant les sous-titres (à importer dans Final Cut)') ?></p></div>
